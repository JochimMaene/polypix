...
Both diagrams are drawn with Polypix itself, so they cannot disagree with the
coverage behavior they explain. Output is SVG on a transparent background,
which keeps the figures readable under both documentation themes.
"""
...
def from_lonlat(
    ...
    """Convert longitude and latitude in degrees to Cartesian unit vectors."""
